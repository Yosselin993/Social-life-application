...
SECRET_KEY = 'django-insecure-v3n@e^qe$b*=fakc&i)et305&hab7t^z%kt9jb@)h_b)5u3tzp'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'mysite' / 'bootstrapTemplate'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'America/Chicago' #changed for accuracy
